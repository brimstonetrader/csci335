...
public class DrawingForest5 extends RandomForest<Drawing,String,DrawingPoint, PixelUse> implements PixelUser {
	private int width, height;

	public DrawingForest5() {
		super(5, Drawing::allFeatures, Drawing::getFeatureValue, PixelUse::successor);
	}
